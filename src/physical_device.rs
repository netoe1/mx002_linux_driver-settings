...
impl PhysicalDevice {
    ...
    pub fn init(&mut self) -> &mut Self {
        self.device_handle
            ...
            .expect("mx002-driver-err:Error detaching old driver.");
        ...
        for interface_descriptor in interface_descriptors {
            self.device_handle
                ...
                .expect("mx002-driver-err:Error claiming interface.");
    ...
    pub fn reset(&mut self) {
        self.device_handle.reset().expect("mx002-driver-err:Error reseting device.");
    }
    ...
    pub fn set_full_mode(&mut self) -> &mut Self {
        ...
        self.set_report(&reports_as_slices)
            .expect("mx002-driver-err:Error sending report.");
        self
    }
